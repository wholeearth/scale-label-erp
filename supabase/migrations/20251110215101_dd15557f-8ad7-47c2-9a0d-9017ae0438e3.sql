-- Drop existing customer update/delete policies for orders (correct names)
...
-- Recreate policies to allow customers to update their own pending or approved orders
